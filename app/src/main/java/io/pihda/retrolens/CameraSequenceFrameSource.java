...
public final class CameraSequenceFrameSource {
    ...
    private void runWorker(CameraEx cameraEx) {
        ...
        try {
            ...
            Logger.info("RetroFrames: starting probe width=" + SOURCE_WIDTH
            ...
            for (int i = 0; i < frames.length; i++) {
                ...
                try {
                    ...
                    if (totalFrames <= 5 || totalFrames % 100 == 0) {
                        Logger.info("RetroFrames: frame=" + totalFrames
                    ...
                    if (!firstFrameReported) {
                        ...
                        Logger.info("RetroFrames: first frame format=" + format
                                + " payloadSize=" + payloadLength);
                        if (listener != null) {
                    ...
                    if (statsElapsedMs >= STATS_INTERVAL_MS) {
                        ...
                        Logger.info("RetroFrames: analyticalFps=" + fps
    ...
    private void dumpDiagnosticJpeg(ByteBuffer buffer, int length) {
        File outputFile = new File(Environment.getExternalStorageDirectory(),
                "RETROLENS/ANALYTICAL_PREVIEW_1.JPG");
