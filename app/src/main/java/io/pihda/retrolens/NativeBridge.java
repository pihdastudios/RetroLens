...
public final class NativeBridge {
    ...
    public static native long nativeCreate(String storageRoot, String cameraModel,
            String versionName);
    ...
    public static native boolean nativeSubmitFrame(long handle, ByteBuffer jpeg,
            int length, long timestampMs);
    ...
    public static native void nativeKey(long handle, int key, boolean down,
            long timestampMs);
    public static native void nativeTouch(long handle, int action, float x, float y,
            long timestampMs);
    ...
    public static native void nativeStopRecording(long handle, boolean interrupted,
            long timestampMs);
}
