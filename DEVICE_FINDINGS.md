...
1. Do not use panel fill as a gate; the top-left-only update is a recorded known defect for this candidate.
2. Traverse multiple categories and confirm all navigation leaves the moving top-left image responsive.
...
5. Open Playback, inspect the RetroLens thumbnail, test delete confirmation on an app derivative, and confirm the Sony original is untouched.
